...
<div id="content">
    ...
    <div class="w800 fl">
        <div class="ui_box4">
            <div class="title">
                <h2 class="tith"><strong class="i1">网点详情</strong></h2>
            </div>
                ...
                <table class="table_data">
                    <tbody class="reg_form">
                        <tr class="bg">
                            ...
                            <td class="tl td_cont"><input type="text" value="<?php echo $info['sp_name'];?>" id="sp_name" class="login-input6" /></td>
                        </tr>
                        <tr>
                            <td class="tl td_bt">网点电话：</td>
                            <td class="tl td_cont"><input type="text" value="<?php echo $info['phone'];?>" id="phone" class="login-input6" /></td>
                        </tr>
                        <tr class="bg">
                            ...
                            <td class="tl td_cont">
                                ...
                                <?php else:?>
                                <input type="radio" value="2" class="status" name="status" />已审核&nbsp;&nbsp;
                                <input type="radio" value="1" class="status" checked name="status" />未审核
                                <?php endif;?>
                            </td>
                        </tr>
                        <tr>
                            <td class="tl td_bt">用户信息：</td>
                            <td class="tl td_cont">
                                <?php if($info['account']):?>
                                    用户昵称：<?php echo $info['nickname'];?><br/>
                                    登录账号：<?php echo $info['account'];?><br/>
                                    联系电话：<?php echo $info['tel'];?>
                                <?php else:?>
                                    未绑定用户 <a href="javascript:bind(<?php echo $info['sp_id'];?>)" title="绑定用户"><img alt="绑定用户" src="<?php echo site_url('assets/images/bind.png');?>"/></a>
                                <?php endif;?>
                            </td>
                        </tr>
                        <tr class="bg">
                            ...
                            <td class="tl td_cont">
                                <?php if($info['status'] == 2):?>
                                    <input type="radio" value="2" class="verify" checked name="verify"/>是&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" value="1" class="verify" name="verify" />否
                                <?php else:?>
                                    <input type="radio" value="2" class="verify" name="verify" />是&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" value="1" class="verify" checked name="verify" />否
                                <?php endif;?>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr class="bg">
                            ...
                            <td class="tl td_cont">
                                <div class="browser">
                                    ...
                                    <input type="hidden" value="<?php echo $info['cover'];?>" id="uploadPath" />
                                </div>
                            </td>
                        </tr>
                        <tr id="upImgStatus">
                            ...
                            <td class="tl td_cont" colspan="3">
                                <div class="showarea" style="width: 300px;height: 225px;text-align:center;">
                                    <img src="<?php echo $info['cover'] ? site_url($info['cover']) : site_url('assets/images/nopic_sp.png');?>" style="width:300px;height: 225px;" class="showimg" id="showUpload"/>
                        ...
                        <tr class="bg">
                            ...
                            <td class="tl td_cont" colspan="3"><textarea class="textarea_sy3" id="intro"><?php echo $info['intro'];?></textarea></td>
                        </tr>
                        <tr>
                            <td class="tl td_bt">网点地址：</td>
                            <td class="tl td_cont" >
                                <input type="text" value="<?php echo $info['address'];?>" id="address" class="login-input6" style="width: 300px;margin-right: 10px;" />
                                <input type="hidden" value="<?php echo $info['lat_baidu'];?>" id="lat" />
                                <input type="hidden" value="<?php echo $info['lng_baidu'];?>" id="lng" />
                                <input type="hidden" value="<?php echo $info['province_id'];?>" id="province" />
                                <input type="hidden" value="<?php echo $info['city_id'];?>" id="city" />
                                <input type="hidden" value="<?php echo $info['district_id'];?>" id="district" />
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        var lat = '<?php echo $info['lat_baidu'];?>';
        var lng = '<?php echo $info['lng_baidu'];?>';
        ...
        $('#tags').tagHandler({
            assignedTags: <?php echo $oldCategory;?>,
        ...
        $(".submit").click(function(){
            ...
            $.post('<?php echo site_url('admin/sp_action/edit');?>',
                {id:id,sp_name:sp_name,phone:phone,status:status,product:product,intro:intro,address:address,lat:lat,lng:lng,province:province,city:city,district:district,verify:verify,cover:cover},
                function(data)
                {
                    if(data.error == 0)
                    {
