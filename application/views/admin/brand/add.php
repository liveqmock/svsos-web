...
<div id="content">
    ...
    <div class="w800 fl">
        <div class="ui_box4">
            <div class="title">
                <h2 class="tith"><strong class="i1">添加品牌</strong></h2>
            </div>
            <div class="cont mh400 pa15">
                <table class="table_data">
                    ...
                    <tr class="bg">
                        ...
                        <td class="tl td_cont"><input type="text" value="" id="name" class="login-input6" /></td>
                    </tr>
                    <tr>
                        <td class="tl td_bt">电话：</td>
                        <td class="tl td_cont"><input type="text" value="" id="tel" class="login-input6" /></td>
                    </tr>
                    <tr class="bg">
                        <td class="tl td_bt">网址：</td>
                        <td class="tl td_cont"><input type="text" value="" id="website" class="login-input6"  /></td>
                    </tr>
                    <tr>
                        <td class="tl td_bt">验证：</td>
                        <td class="tl td_cont">
                            <select class="login-input6" id="verify" style="padding-top: 5px;">
                                <option value="1" selected>未验证</option>
                    ...
                    <tr class="bg">
                        ...
                        <td class="tl td_cont"><input type="text" value="0" id="sort" class="login-input6"  /><span style="color:#999;"> 数字越大排序越靠前</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr class="bg">
                        ...
                        <td class="tl td_cont" colspan="3">
                            <div class="showarea" style="width: 206px;height: 78px;text-align:center;">
                                <img src="" style="width: 206px;height: 78px;" class="showimg" id="showUpload"/>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(".submit").click(function(){
            ...
            $.post('<?php echo site_url('admin/brand_action/add');?>',
                {name:name,tel:tel,website:website,icon:icon,verify:verify,sort:sort},
                function(data)
                {
                    if(data.error == 0)
                    {
